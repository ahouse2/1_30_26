...
try:
    ...
    # Mocking Oso for environments where it's not available (e.g., ARM64 Linux)
    logging.warning("Oso not installed. Using mock implementation that allows all requests.")
    class Oso:
