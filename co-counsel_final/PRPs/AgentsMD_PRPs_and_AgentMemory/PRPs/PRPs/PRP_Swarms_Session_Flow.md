...
This addendum captures the refreshed backend orchestration now powered by the Swarms session graph. The diagrams below map the TRD personas to SDK agents, highlight delegated tool calls, and show how shared memory snapshots persist after every turn.
