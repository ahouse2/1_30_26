...
## Overview
This update replaces the bespoke agents pipeline with a Swarms–style conversation graph. Five TRD roles — Strategy, Ingestion, Research, CoCounsel, and QA — execute as graph nodes with explicit hand-offs, telemetry, and shared memory persisted through `AgentMemoryStore`.
