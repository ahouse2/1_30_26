name: "Planning — Co-Counsel (swarms + LlamaIndex + Swarms)"
description: |
  Generate a concrete PRD/plan for the legal co-counsel MVP using local-first vector+graph RAG, Swarms workflows, and Swarms role schemas.
...
- libraries: Swarms; LlamaIndex core; Neo4j driver; Qdrant/Chroma; image/PDF/email forensics libs (EXIF, PDF parsers, ELA/PRNU methods)
...
Solution: Multi-agent GraphRAG using swarms + LlamaIndex, with citations and graph paths exposed in UI.
