...
- What: Backend services for ingestion, retrieval, graph building; a workflow graph (Swarms); a minimal UI for chat + timeline; and validation gates.
...
## Context
- Reference code:
  - swarms Framework SDK: `Reference Code/swarms`
...
5) Agents Orchestration
   - swarms workflow: nodes (Ingestion, GraphBuilder, Research, Timeline)
