...
| Security | 3 | Spec enumerates strong authN/Z stack, but FastAPI app exposes endpoints without TLS/OAuth/Oso enforcement. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L8-L138】【F:backend/app/main.py†L34-L161】 | Implement mutual TLS termination, OAuth2 validation, Oso policy engine, break-glass logging, scope checks, and audit journaling per PRP.
...
| Documentation | 9 | Comprehensive PRP spec, tasks, roadmaps, validation guides already present. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L1-L160】【F:docs/roadmaps/2025-11-06_prp_execution_phase4.md†L1-L98】 | Update docs with current rubric scores, dependency bootstrap steps, and security implementation plan.
| Compliance | 4 | Spec mandates audit trails, retention, and RBAC; implementation lacks those controls; storage uses local filesystem without encryption. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L8-L138】【F:backend/app/services/ingestion.py†L96-L193】 | Add encrypted storage, audit logging, retention policies, tenant scoping, and compliance reporting pipeline.
...
- **Gap**: Spec requires mutual TLS, OAuth2, and Oso RBAC with break-glass auditing. Current FastAPI entrypoints expose endpoints without any authentication middleware. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L8-L138】【F:backend/app/main.py†L34-L161】
...
### Functional Coverage
- **Gap**: `/query` handler omits pagination, filters, and rerank toggle promised in PRP. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L147-L159】【F:backend/app/main.py†L63-L69】
...
- **Gap**: Ingestion connectors implemented primarily for local filesystem; remote sources (SharePoint, S3, OneDrive, web) need end-to-end validation and credential management per spec. 【F:docs/AgentsMD_PRPs_and_AgentMemory/PRPs/PRP_CoCounsel_Swarms_LlamaIndex_Swarms_spec.md†L43-L86】【F:backend/app/services/ingestion.py†L103-L170】
